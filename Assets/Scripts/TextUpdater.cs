...
public class TextUpdater : MonoBehaviour {
    ...
    void Update()
    {
		...
		if (Input.GetKeyDown("joystick 1 button 2") || (Input.GetKeyDown(KeyCode.P))) { //Replace Tap with Fire1 to use the keyboard's control to pause
